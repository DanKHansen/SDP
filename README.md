...
The SDP is a reference architecture for building **GDPR-compliant**, **cloud-agnostic**, and **fully sovereign** data
platforms. Designed to eliminate vendor lock-in while providing robustness for enterprise-grade BI, ML, and AI
workloads.

**Business Model:** Open Core — Free Community Edition for adoption; Enterprise Features (Advanced Security, Managed
